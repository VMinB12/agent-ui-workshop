...
export const CodeBlockContent = ({
  ...
  const initialTokenized = useMemo(() => highlightCode(code, language) ?? rawTokens, [code, language, rawTokens])

  return (
    <CodeBlockContentInner
      code={code}
      initialTokenized={initialTokenized}
      key={tokensCacheKey}
      language={language}
...
const CodeBlockContentInner = ({
  ...
  language: BundledLanguage
  showLineNumbers: boolean
  initialTokenized: TokenizedCode
}) => {
  const [tokenized, setTokenized] = useState<TokenizedCode>(initialTokenized)

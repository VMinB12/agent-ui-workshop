...
const setBooleanStateInput = (input: ReturnType<typeof useStateMachineInput>, isActive: boolean): void => {
  if (!input) {
    return
  }
  ;(input as { value: boolean }).value = isActive
}
...
export const Persona: FC<PersonaProps> = memo(
  ({ variant = 'obsidian', state = 'idle', onLoad, onLoadError, onReady, onPause, onPlay, onStop, className }) => {
    ...
    useEffect(() => {
      setBooleanStateInput(listeningInput, state === 'listening')
      setBooleanStateInput(thinkingInput, state === 'thinking')
      setBooleanStateInput(speakingInput, state === 'speaking')
      setBooleanStateInput(asleepInput, state === 'asleep')
